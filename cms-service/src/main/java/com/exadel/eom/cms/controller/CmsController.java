...
public class CmsController {
	...
	public void getResource(@PathVariable("storage") String storageName, HttpServletRequest request, HttpServletResponse response)
           throws IOException
    {
        ...
        String etag = storage.getEtag(resourcePath);
